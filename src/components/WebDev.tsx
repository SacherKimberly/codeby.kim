    ...
    <section className="py-32 px-8 md:px-16 lg:px-24 bg-white relative z-10 max-w-7xl mx-auto">
      ...
      <div className="relative">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            {startOptions.map((option, index) => (
              <div 
                key={option.title}
                className="group relative p-8 rounded-2xl transition-all duration-300 hover:transform hover:scale-[1.02] hover:shadow-xl"
                style={{backgroundColor: option.color}}
              >
                {/* Header */}
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 rounded-xl flex items-center justify-center mr-6 group-hover:scale-110 transition-transform duration-300" style={{backgroundColor: '#262525'}}>
                ...
                <div className="hidden lg:block absolute -right-6 top-1/2 transform -translate-y-1/2">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{backgroundColor: '#262525'}}>
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-8 py-4 rounded-full" style={{backgroundColor: '#E4E2DD'}}>
          ...
          {followUpSteps.map((step, index) => (
            <div key={step.title} className="relative">
              ...
              <div className="flex items-center mb-8">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mr-6" style={{backgroundColor: '#262525'}}>
              ...
              {/* Step Content */}
              <div className="ml-18 p-8 rounded-2xl transition-all duration-300 hover:shadow-lg" style={{backgroundColor: '#E4E2DD'}}>
                <div className="flex items-start">
                  <div className="w-16 h-16 rounded-xl flex items-center justify-center mr-8" style={{backgroundColor: '#262525'}}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {step.features.map((feature, featureIndex) => (
                        <div key={feature} className="flex items-center">
                          <div className="w-2 h-2 rounded-full mr-3" style={{backgroundColor: '#262525'}}></div>
                          <span className="font-light font-tt-norms" style={{color: '#262525'}}>
                            {feature}
                          </span>
                        </div>
        ...
        {/* Final CTA */}
        <div className="mt-20 p-12 text-center rounded-2xl" style={{backgroundColor: '#262525'}}>
